  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        />
        <Text style={styles.name}>ณัฐวรรณ พวงมะลัย</Text>
        <Text style={styles.bio}>สาขาวิชาวิทยาการคอมพิวเตอร์และสารสนเทศ</Text>
        <Text style={styles.idNumber}>รหัสนักศึกษา: 653450089-1</Text>
        <Link href={"/about"}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.aboutMeText}>
          ฉันเป็นนักศึกษาคอมพิวเตอร์ที่สนุกกับการเขียนโปรแกรมและการสร้างสรรค์ซอฟต์แวร์ ชอบเปิดรับเทคโนโลยีใหม่ ๆ และทำงานร่วมกับทีมเพื่อพัฒนาไอเดียให้กลายเป็นผลงานจริง
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.skillsContainer}>
          {['JavaScript','Python', 'Java', 'SQL', 'Git', 'HTML/CSS', 'Node.js', 'Docker'].map((skill, index) => (
      ...
      <View style={styles.section}>
        ...
        <View style={styles.educationCard}>
          ...
          <Text style={styles.educationDetail}>เกรดเฉลี่ยสะสม: 2.85</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.interestsContainer}>
          ...
          <View style={styles.interestItem}>
            ...
            <Text style={styles.interestText}>เที่ยว</Text>
          </View>
          <View style={styles.interestItem}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.contactItem}>
          ...
          <Text style={styles.contactText}>Natthawan.p@kkumail.com</Text>
        </View>
        <View style={styles.contactItem}>
          <Ionicons name="call" size={20} color={color.primary} />
          <Text style={styles.contactText}>095-9158319</Text>
        </View>
      </View>
    </ScrollView>
  );
